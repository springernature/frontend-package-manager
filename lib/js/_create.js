...
const generateConfigs = require('./_utils/_generate-configs');
 ...
 */
module.exports = (packageJsonPath, allToolkitsInfo) => {
	...
	(async () => {
		try {
			...
			toolkitDetails = await generateConfigs(packageJsonPath, toolkitDetails);
