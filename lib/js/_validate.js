...
const checkContextDependency = require('./_utils/_check-package-context').validate;
		...
		try {
			...
			for (const toolkit of Object.keys(toolkitConfig)) {
				...
				for (const path of packagePaths) {
					await validatePackage(config, contextConfig.brands, contextConfig.brandContextName, path);
				}
			}
